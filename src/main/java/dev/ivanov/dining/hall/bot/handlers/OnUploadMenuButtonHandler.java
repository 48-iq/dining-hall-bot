...
public class OnUploadMenuButtonHandler implements Handler {
  ...
  public SendMessage handle(Long chatId, Update update) {
    ...
    stateService.setState(chatId, BotStates.UPLOAD_MENU);
    return new SendMessage(chatId.toString(), textService.getText("uploadMenu"));
  }
