...
public class OnTodayMenuButtonHandler implements Handler {
  private static final Logger logger = LoggerFactory.getLogger(OnTodayMenuButtonHandler.class);
  ...
  public SendMessage handle(Long chatId, Update update) {
    ...
    String menu = menuService.getTodayMenu();
